            ...
            <div className="col-12 col-md-12 col-lg-4">
              <div className="card text-center bg-white pb-2">
                  ...
                  <h3 className="card-title">Coding</h3>
                    ...
                    <Link to= "/software" ><button className="btn bg-warning sizeButton">See More</button></Link>
                  </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-12 col-lg-4">
              <div className="card text-center bg-white pb-2">
                  ...
                  <h3 className="card-title">Photography</h3>
                    ...
                    <Link to= "/Photography" ><button className="btn bg-warning sizeButton">See More</button></Link>
                  </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-12 col-lg-4">
              <div className="card text-center bg-white pb-2">
                  ...
                  <h3 className="card-title">Design</h3>
                    ...
                    <Link to= "/Design" ><button className="btn bg-warning sizeButton">See More</button></Link>
                  </div>
              </div>
            </div>
          </div>
